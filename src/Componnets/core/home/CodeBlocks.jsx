...
function CodeBlocks({position,heading,subheading,ctabtn1,ctabtn2,codeblock,bggradiant,codecolor}) {
    return (
        <div className={`flex ${position} my-20 justify-center justify-between gap-10`}>
