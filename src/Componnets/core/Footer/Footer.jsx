...
export default function Footer() {
  return (
    <footer className="w-full bg-richblack-800 text-richblack-200 px-6 py-10">
      {/* Top Section */}
      ...
      {/* Bottom Section */}
      <div className="text-center text-sm text-richblack-200">
        Made with ❤️ Neeraj Nagar © 2026 Studynotion
      </div>
    </footer>
  );
}
